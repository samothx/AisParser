...
var UNITS = {
  ...
  'avgWindSpeed': 'kn',
  'avgGustSpeed': 'kn',
  'avgWindDirection': 'deg',
  'avgGustDirection': 'deg',
  'airTemperature': 'degC',
  'relativeHumidity': 'pct',
  'dewPoint': 'degC',
  'airPressure': 'hPa',
  'airPressureTendency': 'index',
  'horizontalVisibility': 'NM',
  'waterLevel': 'm',
  'waterLevelTrend': 'index',
  'curr1Speed': 'kn',
  'curr1Direction': 'deg',
  'curr2Speed': 'kn',
  'curr2Direction': 'deg',
...
var suppValues = {};
var AisMessage = exports["default"] = /*#__PURE__*/function () {
  ...
  return _createClass(AisMessage, [{
    key: "getUnit",
    ...
    value: function getMidCountry() {
      ...
      if (country) {
        return _short ? country[1] : country[0];
      } else {
        return '';
      }
    }
    ...
    value: function fromError(valid, errMsg) {
      ...
      var msg = new AisMessage(aisType, new _AisBitField["default"]('', 0), channel);
