...
var UNITS = (_UNITS = {
  ...
  'sog': 'kn',
  'cog': 'deg'
}, _defineProperty(_UNITS, 'latitude', 'deg'), _defineProperty(_UNITS, 'longitude', 'deg'), _defineProperty(_UNITS, 'utcTsSec', 's'), _defineProperty(_UNITS, 'utcTsStatus', 'string'), _defineProperty(_UNITS, 'partNo', 'number'), _defineProperty(_UNITS, 'vendorId', 'string'), _defineProperty(_UNITS, 'mothershipMmsi', 'string'), _defineProperty(_UNITS, 'rotStatus', 'string'), _defineProperty(_UNITS, 'rot', 'deg/min'), _defineProperty(_UNITS, 'offPosInd', 'string'), _defineProperty(_UNITS, 'aidType', 'index'), _defineProperty(_UNITS, 'aidTypeStr', 'string'), _defineProperty(_UNITS, 'nameExt', 'string'), _defineProperty(_UNITS, 'midCountry', 'string'), _defineProperty(_UNITS, 'midCountryIso', 'string'), _defineProperty(_UNITS, 'mmsiType', 'string'), _defineProperty(_UNITS, 'text', 'string'), _defineProperty(_UNITS, 'dac', 'number'), _defineProperty(_UNITS, 'fid', 'number'), _defineProperty(_UNITS, 'data', 'binary'), _defineProperty(_UNITS, 'vin', 'string'), _defineProperty(_UNITS, 'length', 'number'), _defineProperty(_UNITS, 'beam', 'number'), _defineProperty(_UNITS, 'shipTypeERI', 'index'), _defineProperty(_UNITS, 'hazard', 'number'), _defineProperty(_UNITS, 'load', 'number'), _defineProperty(_UNITS, 'speedQuality', 'boolean'), _defineProperty(_UNITS, 'courseQuality', 'boolean'), _defineProperty(_UNITS, 'headingQuality', 'boolean'), _UNITS);
