...
var _Ais08MsgDac1Fid3 = require('./Ais08MsgDac1Fid30');

var _Ais08MsgDac1Fid4 = _interopRequireDefault(_Ais08MsgDac1Fid3);

var _Ais08MsgDac1Fid5 = require('./Ais08MsgDac1Fid31');
        ...
        switch (aisType) {
          ...
          case 8:
            ...
            if (sentence.dac == 200 && sentence.fid == 10) {
              ...
              return new _Ais08MsgDac1Fid6.default(aisType, bitField, part[4]);
            } else {
              return sentence;
            }
          case 14:
