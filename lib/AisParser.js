  ...
  _createClass(AisParser, [{
    ...
    value: function parseArray(part) {
      ...
      if (parts !== 7) {
        ...
        if (part[0] !== '!AIVDM' && part[0] !== '!AIVDO' && part[0] !== '!BSVDM' && part[0] !== '!ABVDM' && part[0] !== '!B2VDM' && part[0] !== '!B1VDM') {
    ...
    value: function checksumValid(sentence) {
      if (!(sentence.startsWith('!AIVDO') || sentence.startsWith('!AIVDM') || sentence.startsWith('!BSVDM') || sentence.startsWith('!ABVDM') || sentence.startsWith('!B2VDM') || sentence.startsWith('!B1VDM'))) {
        return false;
      }
