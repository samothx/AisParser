...
var _Ais09Msg = require('./Ais09Msg');

var _Ais09Msg2 = _interopRequireDefault(_Ais09Msg);

var _Ais08Msg = require('./Ais08Msg');

var _Ais08Msg2 = _interopRequireDefault(_Ais08Msg);

var _Ais08MsgDac367Fid = require('./Ais08MsgDac367Fid23');

var _Ais08MsgDac367Fid2 = _interopRequireDefault(_Ais08MsgDac367Fid);

var _Ais08MsgDac367Fid3 = require('./Ais08MsgDac367Fid24');

var _Ais08MsgDac367Fid4 = _interopRequireDefault(_Ais08MsgDac367Fid3);

var _Ais08MsgDac200Fid = require('./Ais08MsgDac200Fid10');

var _Ais08MsgDac200Fid2 = _interopRequireDefault(_Ais08MsgDac200Fid);

var _Ais08MsgDac1Fid = require('./Ais08MsgDac1Fid21');

var _Ais08MsgDac1Fid2 = _interopRequireDefault(_Ais08MsgDac1Fid);

var _Ais08MsgDac1Fid3 = require('./Ais08MsgDac1Fid29');

var _Ais08MsgDac1Fid4 = _interopRequireDefault(_Ais08MsgDac1Fid3);

var _Ais08MsgDac1Fid5 = require('./Ais08MsgDac1Fid30');

var _Ais08MsgDac1Fid6 = _interopRequireDefault(_Ais08MsgDac1Fid5);

var _Ais08MsgDac1Fid7 = require('./Ais08MsgDac1Fid31');

var _Ais08MsgDac1Fid8 = _interopRequireDefault(_Ais08MsgDac1Fid7);

var _Ais14Msg = require('./Ais14Msg');

var _Ais14Msg2 = _interopRequireDefault(_Ais14Msg);
...
var _Ais27Msg = require('./Ais27Msg');

var _Ais27Msg2 = _interopRequireDefault(_Ais27Msg);
    ...
    value: function parseArray(part) {
      ...
      try {
        ...
        switch (aisType) {
          ...
          case 9:
            return new _Ais09Msg2.default(aisType, bitField, part[4]);
          case 8:
            var sentence = new _Ais08Msg2.default(aisType, bitField, part[4]);

            // This Msg has dac and fid in another position
            var d1f30 = new _Ais08MsgDac1Fid6.default(aisType, bitField, part[4]);
            if (d1f30._valid === 'VALID' && d1f30.dac == 1 && d1f30.fid == 30) {
              return d1f30;
            }

            if (sentence.dac == 200 && sentence.fid == 10) {
              return new _Ais08MsgDac200Fid2.default(aisType, bitField, part[4]);
              ...
              return new _Ais08MsgDac367Fid4.default(aisType, bitField, part[4]);
              ...
              return new _Ais08MsgDac1Fid8.default(aisType, bitField, part[4]);
            } else {
              return sentence;
            }
          case 14:
            return new _Ais14Msg2.default(aisType, bitField, part[4]);
          case 18:
          ...
          case 27:
            return new _Ais27Msg2.default(aisType, bitField, part[4]);
          default:
