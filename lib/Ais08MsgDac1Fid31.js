...
|==============================================================================
*/
var Ais8MsgDac1Fid31 = exports["default"] = /*#__PURE__*/function (_AisMessage) {
  function Ais8MsgDac1Fid31(aisType, bitField, channel) {
    var _this;
    _classCallCheck(this, Ais8MsgDac1Fid31);
    _this = _callSuper(this, Ais8MsgDac1Fid31, [aisType, bitField, channel]);
  ...
  return _createClass(Ais8MsgDac1Fid31, [{
    key: "class",
    get: function get() {
      return 'A';
    }
    ...
    key: "utcHour",
    get: function get() {
      var val = this._bitField.getInt(111, 5, true);
      if (val >= 24) {
        return NaN;
      } else {
        return val;
    ...
    key: "utcMinute",
    get: function get() {
      var val = this._bitField.getInt(116, 6, true);
      if (val >= 60) {
        return NaN;
      } else {
        return val;
    ...
    key: "avgWindSpeed",
    get: function get() {
      var val = this._bitField.getInt(122, 7, true);
      if (val >= 127) {
        return NaN;
      } else {
        return val;
    ...
    key: "avgGustSpeed",
    get: function get() {
      var val = this._bitField.getInt(129, 7, true);
      if (val >= 127) {
        return NaN;
      } else {
        return val;
    ...
    get: function get() {
      var val = this._bitField.getInt(136, 9, true);
      if (val >= 360) {
        return NaN;
      } else {
        return val;
    ...
    get: function get() {
      var val = this._bitField.getInt(145, 9, true);
      if (val >= 360) {
        return NaN;
      } else {
        return val;
    ...
    key: "airTemperature",
    get: function get() {
      var val = this._bitField.getInt(154, 11, false);
      if (val == -1024) {
        return NaN;
      } else {
        return val / 10.0;
    ...
    get: function get() {
      var val = this._bitField.getInt(165, 7, true);
      if (val >= 101) {
        return NaN;
      } else {
        return val;
    ...
    key: "dewPoint",
    get: function get() {
      var val = this._bitField.getInt(172, 10, false);
      if (val >= 501) {
        return NaN;
      } else {
        return val / 10.0;
    ...
    key: "airPressure",
    get: function get() {
      var val = this._bitField.getInt(182, 9, true);
      if (val == 0) {
        return 799;
      } else if (val == 402) {
        return 1201;
    ...
    get: function get() {
      var val = this._bitField.getInt(191, 2, true);
      switch (val) {
        case 0:
          return 'STEADY';
        case 1:
    ...
    get: function get() {
      var val = this._bitField.getInt(193, 8, true);
      if (val >= 127) {
        return NaN;
      } else {
        return val / 10.0;
    ...
    key: "waterLevel",
    get: function get() {
      var val = this._bitField.getInt(201, 12, true);
      if (val >= 4001) {
        return NaN;
      } else {
        return val / 100.0 - 10;
    ...
    key: "waterLevelTrend",
    get: function get() {
      var val = this._bitField.getInt(213, 2, true);
      switch (val) {
        case 0:
          return 'STEADY';
        case 1:
    ...
    key: "curr1Speed",
    get: function get() {
      var val = this._bitField.getInt(215, 8, true);
      if (val >= 251) {
        return NaN;
      } else {
        return val / 10.0;
    ...
    key: "curr1Direction",
    get: function get() {
      var val = this._bitField.getInt(223, 9, true);
      if (val >= 360) {
        return NaN;
      } else {
        return val;
    ...
    key: "curr2Speed",
    get: function get() {
      var val = this._bitField.getInt(232, 8, true);
      if (val >= 251) {
        return NaN;
      } else {
        return val / 10.0;
    ...
    key: "curr2Direction",
    get: function get() {
      var val = this._bitField.getInt(240, 9, true);
      if (val >= 360) {
        return NaN;
      } else {
        return val;
    ...
    key: "curr2Level",
    get: function get() {
      var val = this._bitField.getInt(249, 5, true);
      if (val >= 31) {
        return NaN;
      } else {
        return val;
    ...
    key: "curr3Speed",
    get: function get() {
      var val = this._bitField.getInt(254, 8, true);
      if (val >= 251) {
        return NaN;
      } else {
        return val / 10.0;
    ...
    key: "curr3Direction",
    get: function get() {
      var val = this._bitField.getInt(262, 9, true);
      if (val >= 360) {
        return NaN;
      } else {
        return val;
    ...
    key: "curr3Level",
    get: function get() {
      var val = this._bitField.getInt(271, 5, true);
      if (val >= 31) {
        return NaN;
      } else {
        return val;
    ...
    key: "sigWaveHeight",
    get: function get() {
      var val = this._bitField.getInt(276, 8, true);
      if (val >= 251) {
        return NaN;
      } else {
        return val / 10.0;
    ...
    key: "wavePeriod",
    get: function get() {
      var val = this._bitField.getInt(284, 6, true);
      if (val >= 61) {
        return NaN;
      } else {
        return val;
    ...
    key: "waveDirection",
    get: function get() {
      var val = this._bitField.getInt(290, 9, true);
      if (val >= 360) {
        return NaN;
      } else {
        return val;
    ...
    key: "swellHeight",
    get: function get() {
      var val = this._bitField.getInt(299, 8, true);
      if (val >= 251) {
        return NaN;
      } else {
        return val / 10.0;
    ...
    key: "swellPeriod",
    get: function get() {
      var val = this._bitField.getInt(307, 6, true);
      if (val >= 61) {
        return NaN;
      } else {
        return val;
    ...
    key: "swellDirection",
    get: function get() {
      var val = this._bitField.getInt(313, 9, true);
      if (val >= 360) {
        return NaN;
      } else {
        return val;
    ...
    key: "seaState",
    get: function get() {
      var val = this._bitField.getInt(322, 4, true);
      if (val >= 13) return NaN;
      return val;
    }
    ...
    get: function get() {
      var val = this._bitField.getInt(326, 10, false);
      if (val >= 501) {
        return NaN;
      } else {
        return val / 10.0;
    ...
    get: function get() {
      var val = this._bitField.getInt(336, 3, true);
      switch (val) {
        case 0:
          return 'RESERVED';
        case 1:
    ...
    key: "salinity",
    get: function get() {
      var val = this._bitField.getInt(339, 9, true);
      if (val >= 510) {
        return NaN;
      } else {
        return val / 10.0;
    ...
    key: "ice",
    get: function get() {
      var val = this._bitField.getInt(348, 2, true);
      if (val >= 3) {
        return NaN;
      } else {
        return val;
